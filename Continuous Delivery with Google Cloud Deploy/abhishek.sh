...
echo
echo "${DR_PURPLE}${BOLD_TEXT}💖 Enjoyed this tutorial? Consider subscribing to Dr. Abhishek Cloud Tutorials! 👇${RESET_FORMAT}"
echo "${DR_BLUE}${BOLD_TEXT}${UNDERLINE_TEXT}https://youtube.com/@drabhishek.5460${RESET_FORMAT}"
echo
