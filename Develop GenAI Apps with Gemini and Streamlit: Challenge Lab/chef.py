...
@st.cache_resource
def load_models():
    return GenerativeModel("gemini-1.5-pro-preview")
...
st.write("Using Gemini 1.5 Pro - Text only model")
...
if generate_t2t:
    if not cuisine or not dietary_preference:
        ...
        with st.spinner("Generating your recipes using Gemini 1.5 Pro..."):
            try:
